    ...
    return (
        <div className='bg-[#140c1c] rounded-lg p-4 sm:p-10'>
            ...
            <form className='mt-8 block w-full overflow-hidden'>
                ...
                placeholder:text-gray-600 px-6 py-3 rounded-md border-[1.5px] border:-gray-200 
                ...
                rounded-md border-[1.5px] border-gray-200 border-opacity-15 outline-none'>
                        ...
                        <option value="forntend">Forntend Development</option>
                        <option value="backend">Backend Development</option>
                        <option value="fullstack">Fullstack Development</option>
                    </select>
                </div>
                <textarea className='w-full mt-5 bg-black text-white placeholder:text-gray-600 px-4 py-3.5
                rounded-md border-[1.5px] border-gray-200 border-opacity-15 outline-none'
                    rows={7}
                    placeholder='Message'
                ></textarea>
